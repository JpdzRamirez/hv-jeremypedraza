...
import CertificationsCard from './CertificationsCardComponent.vue';
    ...
    <div class="app">
        <div class="header-title">
            <div class="header__input-menu">
                ...
                <a href="" class="header__input-minimize"></a>
            </div>
                                ...
                                <div class="button-wrapper">
                                    ...
                                    <div class="pop_mode">
                                        <div class="pop-up__title">Update This App
                                            <svg width="24" height="24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-x-circle close">
